#! /bin/bash
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #  
# GPIO INFO at http://elinux.org/RPi_Low-level_peripherals                   #
#                                                                             #     
# Configure RPi GPIO pins for direction: read/write and                       #
# takes actions if someone interacts with the selected pins.                  #
#                                                                             #
